...
export const IDEAL_SWING_KEYPOINTS: Record<SwingPhase, IdealKeypoints> = {
  ...
  setup: {
    nose: { x: 0.50, y: 0.22 },
    left_shoulder: { x: 0.47, y: 0.33 },
    right_shoulder: { x: 0.53, y: 0.33 },
    left_elbow: { x: 0.42, y: 0.43 },
    right_elbow: { x: 0.58, y: 0.43 },
    left_wrist: { x: 0.40, y: 0.48 },
    right_wrist: { x: 0.60, y: 0.48 },
  ...
  load: {
    ...
    right_shoulder: { x: 0.56, y: 0.35 },  // Shoulders start rotating back
    left_elbow: { x: 0.43, y: 0.45 },
    right_elbow: { x: 0.64, y: 0.42 },  // Back elbow up and back
    left_wrist: { x: 0.41, y: 0.51 },
    right_wrist: { x: 0.68, y: 0.46 },  // Hands loaded back
    left_hip: { x: 0.49, y: 0.55 },
    right_hip: { x: 0.56, y: 0.54 },  // Back hip loaded, slightly rotated
    left_knee: { x: 0.47, y: 0.73 },
    right_knee: { x: 0.57, y: 0.71 },  // Back knee flexed over ankle
    left_ankle: { x: 0.46, y: 0.90 },
  ...
  stride: {
    nose: { x: 0.50, y: 0.23 },
    left_shoulder: { x: 0.46, y: 0.34 },
    right_shoulder: { x: 0.54, y: 0.35 },
    left_elbow: { x: 0.38, y: 0.44 },
    right_elbow: { x: 0.62, y: 0.41 },
    left_wrist: { x: 0.34, y: 0.50 },  // Hands still back despite body moving forward
    right_wrist: { x: 0.66, y: 0.45 },
    left_hip: { x: 0.47, y: 0.54 },  // Hips start opening
    right_hip: { x: 0.53, y: 0.53 },
    left_knee: { x: 0.38, y: 0.71 },  // Front knee flexed, ready to block
    right_knee: { x: 0.55, y: 0.70 },  // Back knee driving forward
    left_ankle: { x: 0.34, y: 0.90 },  // Front foot planted
  ...
  contact: {
    nose: { x: 0.47, y: 0.24 },
    left_shoulder: { x: 0.42, y: 0.35 },  // Shoulders square to pitch
    right_shoulder: { x: 0.50, y: 0.36 },
    left_elbow: { x: 0.32, y: 0.41 },  // Front arm extended
    right_elbow: { x: 0.56, y: 0.38 },  // Back elbow "slotted"
    left_wrist: { x: 0.26, y: 0.44 },  // Hands through zone, slight upward path
    right_wrist: { x: 0.60, y: 0.42 },
    left_hip: { x: 0.44, y: 0.54 },  // Hips fully open/rotated
    right_hip: { x: 0.50, y: 0.53 },
    left_knee: { x: 0.36, y: 0.71 },  // Front leg firm (blocking)
    right_knee: { x: 0.52, y: 0.68 },  // Back knee driving through
    left_ankle: { x: 0.34, y: 0.90 },
    right_ankle: { x: 0.56, y: 0.88 },  // Back heel lifting
  },
  ...
  extension: {
    nose: { x: 0.44, y: 0.26 },
    left_shoulder: { x: 0.38, y: 0.37 },
    right_shoulder: { x: 0.46, y: 0.37 },
    left_elbow: { x: 0.28, y: 0.39 },  // Full extension
    right_elbow: { x: 0.52, y: 0.37 },
    left_wrist: { x: 0.22, y: 0.40 },  // Arms extended through ball
    right_wrist: { x: 0.56, y: 0.38 },
    left_hip: { x: 0.42, y: 0.56 },  // Full rotation
    right_hip: { x: 0.47, y: 0.55 },
    left_knee: { x: 0.34, y: 0.72 },
    right_knee: { x: 0.48, y: 0.67 },  // Back leg continues through
    left_ankle: { x: 0.32, y: 0.90 },
    right_ankle: { x: 0.52, y: 0.85 },  // On toe
  },
  ...
  finish: {
    nose: { x: 0.40, y: 0.28 },
    left_shoulder: { x: 0.34, y: 0.39 },  // Full body rotation
    right_shoulder: { x: 0.42, y: 0.39 },
    left_elbow: { x: 0.24, y: 0.43 },
    right_elbow: { x: 0.46, y: 0.34 },  // High finish
    left_wrist: { x: 0.20, y: 0.47 },
    right_wrist: { x: 0.50, y: 0.30 },  // Hands high
    left_hip: { x: 0.38, y: 0.57 },
    right_hip: { x: 0.43, y: 0.56 },
    left_knee: { x: 0.32, y: 0.73 },  // Front leg stable
    right_knee: { x: 0.44, y: 0.68 },  // Back knee through
    left_ankle: { x: 0.30, y: 0.90 },
    right_ankle: { x: 0.48, y: 0.82 },  // Back foot fully rotated
  },
};
